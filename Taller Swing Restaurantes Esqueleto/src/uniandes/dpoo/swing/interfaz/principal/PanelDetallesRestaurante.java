...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    public PanelDetallesRestaurante( )
    {
    	...
    	this.chkVisitado = new JCheckBox("Visitado: ", false);
    	add(labNombre, BorderLayout.NORTH);
    	add(labCalificacion, BorderLayout.CENTER);
    	add(chkVisitado, BorderLayout.SOUTH);
    	setVisible(false);
    ...
    private void actualizarRestaurante( String nombre, int calificacion, boolean visitado )
    {
    	...
    	ImageIcon jcal = buscarIconoCalificacion(calificacion);
    	labCalificacion.setIcon(jcal);
